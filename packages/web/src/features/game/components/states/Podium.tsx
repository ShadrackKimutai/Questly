...
import useScreenSize from "@questly/web/hooks/useScreenSize"
      ...
      <section className="relative mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-between">
        ...
        >
          {top[1] && (
            ...
            >
              <span className={clsx(
                "text-6xl leading-none drop-shadow-lg md:text-7xl",
                { "anim-dance": apparition >= 4 },
              )}>{top[1].mascot}</span>
              <p
                className={clsx(
          ...
          >
            <span className={clsx(
              ...
              { "opacity-100 anim-dance": apparition >= 4 },
            )}>{top[0].mascot}</span>
            <p
              className={clsx(
